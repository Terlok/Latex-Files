...
\newpage
    ...
    \begin{enumerate}
        ...
        \begin{figure}[h!]
            \begin{center}
                \includegraphics[scale=0.35]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_1.jpg}
            \end{center}
        \end{figure}
        \item Після завантаження встановлюємо застосунок. Отримаємо таке повідомлення.
        \begin{figure}[h!]
            \begin{center}
                \includegraphics[scale=0.8]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_2.jpg}
            \end{center}
        \end{figure}
\newpage
        ...
        \begin{figure}[h!]
            \begin{center}
                \includegraphics[scale=0.35]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_3.jpg}
            \end{center}
        \end{figure}
        \item Ось так виглядає Jupyter Notebook.
        \begin{figure}[h!]
            \begin{center}
                \includegraphics[scale=0.35]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_4.jpg}
            \end{center}
        \end{figure}
    \end{enumerate}
\newpage
...
\newpage
    ...
    \begin{enumerate}
        ...
        \begin{figure}[h!]
            \begin{center}
                \includegraphics[scale=0.9]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_5.jpg}
            \end{center}
        \end{figure}
    ...
    \begin{figure}[h!]
        \begin{center}
            \includegraphics[scale=0.7]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_9.jpg}
        \end{center}
    \end{figure}
    ...
    \begin{enumerate}
        ...
        \begin{figure}[h!]
            \begin{center}
                \includegraphics[scale=0.7]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_10.jpg}
            \end{center}
        \end{figure}
\newpage
        ...
        \begin{figure}[h!]
            \begin{center}
                \includegraphics[scale=0.7]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_11.jpg}
            \end{center}
        \end{figure}
        \item Обираємо поле "Flask" та натискаємо "Enter".
        \begin{figure}[h!]
            \begin{center}
                \includegraphics[scale=0.7]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_12.jpg}
            \end{center}
        \end{figure}
\newpage
        ...
        \begin{figure}[h!]
            \begin{center}
                \includegraphics[scale=0.6]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_13.jpg}
            \end{center}
        \end{figure}
    \end{enumerate}
...
\newpage
    ...
    \begin{figure}[h!]
        \begin{center}
            \includegraphics[scale=0.35]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_6.jpg}
        \end{center}
    \end{figure}
    \begin{enumerate}
...
\newpage
    ...
    \begin{figure}[h!]
        \begin{center}
            \includegraphics[scale=0.8]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_7.jpg}
        \end{center}
    \end{figure}
\newpage
    ...
    \begin{figure}[h!]
        \begin{center}
            \includegraphics[scale=0.35]{D:/Projects/Latex/SPR_CourseWork/Pictures/Figure_8.jpg}
        \end{center}
    \end{figure}
...
\newpage
    ...
    \href{https://www.kaggle.com/datasets/thedevastator/get-your-game-on-metacritic-recommendations-and}{DataSet}
