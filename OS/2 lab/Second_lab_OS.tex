...
\newpage
    ...
    \begin{figure}[h!]
        ...
        \end{minipage}
    \end{figure} \\
    Команду <<chown>> можна використовувати лише від імені супер-юзера. Тобто потрібно виконувати команду від імені <<sudo>>.\\
    Приклад вірної команди: <<sudo chown test lab\_2>>.
