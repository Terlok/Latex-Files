...
\newpage
    ...
    \begin{figure}[h!]
        ...
        \end{minipage}
    \end{figure} \\
    - Юзер не може передати права власності на файл іншому юзеру без використання sudo, щоб запобігти несанкціонованому доступу та передачі зі сторони
    користувачів які користуються однім комп'ютером. Тобто з огляду безпеки це запобіжник передачі ваших файлів, без вашого відома.\\
    - Каталог містить файли або підкаталоги, які вам не належать. Якщо в каталозі є файли або підкаталоги, які належать іншому користувачу або групі, 
    то ви не зможете змінити власника каталогу, оскільки ви не маєте прав на зміну власника цих файлів або підкаталогів. \\
    - Каталог містить посилання на інші файли або каталоги, то зміна власника цього каталогу 
    може вплинути на права доступу до цих файлів і каталогів, що може мати наслідки. 
